...
說明：使用者從廠商選擇付款方式、金額等資訊啟動的交易，並從廠商端Server發起交易請求，儲值中心在過程中會進行確認請求的動作，以核對使用者是否已完成廠商端的必要作業(e.g.出金時要先扣掉玩家的點數)，確認無誤後將訊息傳送給付費平台。

適用付費平台：出金相關通路。 **注意事項同 (一)廠商標準流程**
...
| 104 | 銀聯國際充值 | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/Chinapay/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/Chinapay/Order.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 109 | Google Play 國際充值 | (三)付費平台標準流程 |  |  | 提出交易請求電文連結位置：<br/>測試機：<BR>(1)開webview 並傳送收據 (儲值結果由網頁顯示)<BR>https://bank-twtest.towergame.com/bank/GooglePlay/Settle.aspx<BR>(2)API 傳送收據 (儲值結果由遊戲實作)<BR>https://bank-twtest.towergame.com/common/receive/GooglePlay/Settle.aspx<br/>正式機：<BR>(1)開webview 並傳送收據 (儲值結果由網頁顯示)<BR>https://bank.gametower.com.tw/bank/GooglePlay/Settle.aspx<BR>(2)API 傳送收據 (儲值結果由遊戲實作)<BR>https://bank.gametower.com.tw/common/receive/GooglePlay/Settle.aspx<br/>可直接串接的儲值中心：不限 |
| 117 | AppStore 國際充值 | (三)付費平台標準流程 |  |  | 提出交易請求電文連結位置：<br/>測試機：<BR>(1)開webview 並傳送收據 (儲值結果由網頁顯示)<BR>https://bank-twtest.towergame.com/bank/AppStore/Settle.aspx<BR>(2)API 傳送收據 (儲值結果由遊戲實作)<BR>https://bank-twtest.towergame.com/common/receive/AppStore/Settle.aspx<br/>正式機：<BR>(1)開webview 並傳送收據 (儲值結果由網頁顯示)<BR>https://bank.gametower.com.tw/bank/AppStore/Settle.aspx<BR>(2)API 傳送收據 (儲值結果由遊戲實作)<BR>https://bank.gametower.com.tw/common/receive/AppStore/Settle.aspx <br/>可直接串接的儲值中心：不限 |
...
| 185 | 閃快 – 支付寶儲值 | (一)廠商標準流程 | | | 提出交易請求電文連結位置(該渠道串接的儲值中心Domain是GT365的)：<br/>開發機：https://bank.gt.web/Bank/TYPay/Alipay/Order.aspx<br />測試機：https://bank-gt365-test.towergame.com/Bank/TYPay/Alipay/Order.aspx <br/>正式機：https://bc.gt365.com/Bank/TYPay/Alipay/Order.aspx <br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>一開始提出交易請求收到訂單後會回傳000005到RETURN_URL(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。)；直到TYPay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。 |
...
| 200 | 馬來 GrabPay (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 201 | 馬來 Boost (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 202 | 馬來 Touch 'n Go (CodaPay) | (一)廠商標準流程 | | | CodaPay - 馬來 - 錢包 - Touch 'n Go儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/CodaPay/MalaysiaTouchGo/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/CodaPay/MalaysiaTouchGo/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/>PS.延伸欄位多帶ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +)、MOBILE_MODE_FLAG(導向CodaPay付款頁面是否為手機版的模式，請傳入true OR false) |
| 202 | 馬來 Touch 'n Go (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 205 | GASH銀聯 | (一)廠商標準流程 | | | 請參考104-銀聯國際充值說明 |
| 206 | MyBillingPay MyCard轉點 | (一)廠商標準流程 | | 是 | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/CostPoint/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/CostPoint/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 207 | 泰國 Rabbit LINE Pay (CodaShop) | (三)付費平台標準流程 | |  | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 208 | 泰國 True Money Wallet (CodaShop) | (三)付費平台標準流程 | |  | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 209 | 泰國 Bank Transfer (CodaShop) | (三)付費平台標準流程 | |  | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 210 | 泰國 7 Eleven (CodaShop) | (三)付費平台標準流程 | |  | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 211 | 泰國 Card Payment (CodaShop) | (三)付費平台標準流程 | |  | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 212 | MyBillingPay台灣Pay | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/TaiwanPay/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/TaiwanPay/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 213 | MyBillingPay合作金庫WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/CoopWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/CoopWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 214 | MyBillingPay上海銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/ShanghaiWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/ShanghaiWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 215 | MyBillingPay土地銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/LandWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/LandWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 216 | MyBillingPay中國信託WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/CtbcWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/CtbcWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 217 | MyBillingPay中華郵政WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/ChPostWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/ChPostWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 218 | MyBillingPay台北富邦WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/FubonWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/FubonWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 219 | MyBillingPay台新銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/TaishinWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/TaishinWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 220 | MyBillingPay台灣銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/TaiwanWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/TaiwanWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 221 | MyBillingPay玉山銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/EsunWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/EsunWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 222 | MyBillingPay兆豐銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/MegaWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/MegaWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 223 | MyBillingPay第一銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/FirstWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/FirstWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 224 | MyBillingPay華南銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/HuananWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/HuananWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 225 | MyBillingPay彰化銀行WebATM | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/ChanghwaWebATM/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/ChanghwaWebATM/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 226 | MyBillingPay銀行轉帳 | (一)廠商標準流程 | |  | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MyBillingPay/BankTransfer/Order.aspx<br/>正式機：https://bank.gametower.com.tw/Bank/MyBillingPay/BankTransfer/Order.aspx<br/>此金流禁止頁面被 frame 內嵌<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 227 | 馬來 Bank Transfers FPX (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 228 | 馬來 Card Payment (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 229 | 馬來 Shopee Pay (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 230 | 泰國 Coda Cash (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 231 | 泰國 KPlus (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 232 | 泰國 TrueMoney CashCard (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 233 | 馬來 Bank Transfers MAE (CodaShop) | (三)付費平台標準流程 | | | 提供給 CodaShop 呼叫：<br/>測試機：<br>Validate API：https://bank-twtest.towergame.com/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank-twtest.towergame.com/common/receive/CodaPay/topup.aspx<br/>正式機：<br />Validate API：https://bank.gametower.com.tw/common/receive/CodaPay/Validation.aspx<br />Top up API：https://bank.gametower.com.tw/common/receive/CodaPay/topup.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 659 | SeastarPay | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/SeastarPay/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/SeastarPay/Order.aspx <br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：柬埔寨滿貫大亨儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 661 | 越南聯發 VGPAY | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VGPay/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VGPay/Order.aspx <br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：柬埔寨滿貫大亨儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 708 | JSTPay | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/JSTPay/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/JSTPay/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：泰版捕魚儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/>PS.幣別為THB |
| 801 | Momo_QR (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Momo_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Momo_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 802 | Zalo_QR (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Zalo_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Zalo_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 803 | Upacp_PC (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Upacp_PC/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Upacp_PC/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 804 | Bank_Transfer (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Bank_Transfer/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Bank_Transfer/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 805 | Bank_QR (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Bank_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Bank_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 806 | Viettel_QR (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Viettel_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Viettel_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 807 | Viettel_Fix_QR  (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Viettel_Fix_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Viettel_Fix_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 808 | Rcgcard_PC  (VNPay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/VNPay/Rcgcard_PC/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/VNPay/Rcgcard_PC/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 809 | Momo_QR (TruePay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/TruePay/Momo_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/TruePay/Momo_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 810 | Zalo_QR (TruePay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/TruePay/Zalo_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/TruePay/Zalo_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 811 | Bank_Transfer (TruePay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/TruePay/Bank_Transfer/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/TruePay/Bank_Transfer/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
| 812 | Bank_QR (TruePay) | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/TruePay/Bank_QR/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/TruePay/Bank_QR/Order.aspx<br/><br/>※此路徑皆已台灣版儲值中心為主，若為泰國版滿貫大亨或是柬埔寨版滿貫大亨...etc的<br/>DOMAIN 請跟網頁組詢問。<br/><br/>可直接串接的儲值中心：金銀島越南儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/> |
...
| 銀聯 國際充值 | (三) 交易結果電文<br>(四) 交易回報確認電文 | 儲值中心<br>↓<br>廠商 | USE_PAY_TYPE_NO=205<br>USE_PAY_TYPE_NO：渠道商，205 表示 GASH銀聯 |
...
| Google Play 國際充值 | (一)提出交易請求電文 | 廠商<br>↓<br>儲值中心 | f_strSignedData={收據，googleplay function：getOriginalJson() }<br>f_strSignature={簽章，googleplay function：getSignature() }<br/>f_strStartID={品項，googleplay function：getSku() }<br/>f_strUserID={玩家識別值，GT相關專案請帶入LC 登入碼}<br/>f_strPlatformData={廠商資料(廠商自訂字串，會於確認請求時回傳)，格式為 QueryString}<br/>f_bIsSubscription={是否為訂閱品項收據，當值為 true 或 True 或 1 時走訂閱處理}<br/><br/>※f_strPlatformData 可以做為 APP客製化規格使用<BR>例如：紀錄玩家機碼、實際幣別(各地區退費觀察)、使用者 IP、區分伺服器…等<br>範例：f_strIP=1.2.3.4&USER_CURRENCY_ID=TWD&DEVICE_ID=aaa-bbb-ccc-ddd-eee&f_nPrizeType=123 |
...
| Google Play 國際充值                                         | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PRODUCT_ID=1&CURRENCY_ID=HKD<br>&CURRENCY_RATE=30.1&NT_AMOUNT=35.2<br>&APP_ID=371.com.tw<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>CURRENCY_ID：欲儲值的貨幣ID，varchar(10)<br>CURRENCY_RATE：該貨幣的買進匯率，decimal<br>NT_AMOUNT：換算的台幣金額，decimal<br>APP_ID：識別是儲值到哪個App<BR><BR>使用四、(三)(2)API 傳送收據的回傳結果：{結果代碼},{品項}<BR>例如：1,com.igs.mjstar31.aio.coin.managed_15000<BR>結果代碼 (1-成功 2-失敗 3-過期 4-訂閱與原始訂單帳號不同錯誤)<BR>結果代碼1、3可以消滅儲存的收據，否則需另排時間重送(例如玩家重登的時候，補送卡單的收據)<BR><BR>GT相關專案使用四、(三)(1)開webview 並傳送收據<BR>網頁會透過 javascript 告知遊戲<br>呼叫window.hippo.igsCallBackPurchaseStateChanged(結果代碼, '品項ID')<br>結果代碼 (1：成功，2：失敗)<br>結果代碼1可以消滅儲存的收據，否則需另排時間重送(例如玩家重登的時候，補送卡單的收據) |
| AppStore 國際充值 | (一)提出交易請求電文 | 廠商<br>↓<br>儲值中心 | f_strReceiptData={收據，App Store回傳的 RECEIPT_DATA }<br>f_strStartID={IOS訂單編號}<br/>f_strUserID={玩家識別值，GT相關專案請帶入LC 登入碼}<br/>f_strPlatformData={廠商資料(廠商自訂字串，會於確認請求時回傳)，格式為 QueryString}<br/><br/>※f_strPlatformData 可以做為 APP客製化規格使用<BR>例如：紀錄玩家機碼、實際幣別(各地區退費觀察)、使用者 IP、區分伺服器…等<br>範例：f_strIP=1.2.3.4&USER_CURRENCY_ID=TWD&DEVICE_ID=aaa-bbb-ccc-ddd-eee&f_nPrizeType=123 |
...
| AppStore 國際充值                                            | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PRODUCT_ID=1&CURRENCY_ID=HKD<br>&CURRENCY_RATE=30.1&NT_AMOUNT=35.2<br>&APP_ID=371.com.tw<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>CURRENCY_ID：欲儲值的貨幣ID，varchar(10)<br>CURRENCY_RATE：該貨幣的買進匯率，decimal<br>NT_AMOUNT：換算的台幣金額，decimal<br>APP_ID：識別是儲值到哪個App<BR><BR>使用四、(三)(2)API 傳送收據的回傳結果：{結果代碼},{品項}<BR>例如：1,com.igs.mjstar31.aio.coin.managed_15000<BR>結果代碼 (1-成功 2-失敗 3-過期 4-訂閱與原始訂單帳號不同錯誤)<BR>結果代碼1、3可以消滅儲存的收據，否則需另排時間重送(例如玩家重登的時候，補送卡單的收據) |
...
| MyCard 儲值卡                                                | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | CARD_TYPE=2&PROMO_CODE=xxxx<br>&CARD_ID=xxxx<br>&ORIGINAL_CURRENCY_ID=MYR<br>&ORIGINAL_AMOUNT=1000<br>CARD_TYPE：卡別 <br />    2：一般、4：超商(舊的)、5：海外(港澳)、6：海外(舊的)、7：海外(大馬)、8：海外(港澳2)、9：7-11超商、18：全家超商、20-行動遊戲卡、32：海外(大馬2)、33：萊爾富、OK超商、34：海外(大馬3)、36：海外(港澳3)、37："海外(印尼)、38：海外(大馬20171001)、42：海外(大馬20180312)、47：海外(大馬_20210901)<br>PROMO_CODE：活動代號，varchar(6)<br>CARD_ID：玩家儲值的卡號，原始長度char(16)<br>ORIGINAL_CURRENCY_ID：原始幣別<br>ORIGINAL_AMOUNT：原始幣別金額<br>注意：當RESULT_CODE=000000時，才會帶值 |
...
| PPS繳費靈(智冠)<br>港澳Visa信用卡(智冠)<br>八達通(智冠)<br>MyCard轉點<br>台灣Pay(智冠)<br>合作金庫WebATM(智冠)<br>上海銀行WebATM(智冠)<br>土地銀行WebATM(智冠)<br>中國信託WebATM(智冠)<br>中華郵政WebATM(智冠)<br>台北富邦WebATM(智冠)<br>台新銀行WebATM(智冠)<br>台灣銀行WebATM(智冠)<br>玉山銀行WebATM(智冠)<br>兆豐銀行WebATM(智冠)<br>第一銀行WebATM(智冠)<br>華南銀行WebATM(智冠)<br>彰化銀行WebATM(智冠)<br>銀行轉帳(智冠) | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | ORDER_DESC=XXXXXXXX<br>ORDER_DESC：商品說明，varchar(50)<br><br>若為街口支付或MyCard轉點且儲值方式是在安卓遊戲內的話<br>延伸欄位多帶APP_HOST_NAME、APP_SCHEME_NAME、APP_PACKAGE_NAME<br>詳細說明請看『四、付款方式代碼表』 |
| PPS繳費靈(智冠)<br>港澳Visa信用卡(智冠)<br>八達通(智冠)<br>MyCard轉點<br>台灣Pay(智冠)<br>合作金庫WebATM(智冠)<br>上海銀行WebATM(智冠)<br>土地銀行WebATM(智冠)<br>中國信託WebATM(智冠)<br>中華郵政WebATM(智冠)<br>台北富邦WebATM(智冠)<br>台新銀行WebATM(智冠)<br>台灣銀行WebATM(智冠)<br>玉山銀行WebATM(智冠)<br>兆豐銀行WebATM(智冠)<br>第一銀行WebATM(智冠)<br>華南銀行WebATM(智冠)<br>彰化銀行WebATM(智冠)<br>銀行轉帳(智冠) | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PROMO_CODE =XXXXXX<br>PROMO_CODE：活動代號，varchar(6)       |
...
| SeastarPay                                                   | (一)提出交易請求電文                                         | 廠商<br/>↓<br/>儲值中心 | PRODUCT_TYPE={支付通道}<br>LANG={語系}<br/><br/>[支付通道]<br/>xx_acleda:Acleda<br/>xx_wing:Wing<br/>xx_aba:ABA<br/>xx_jiahua:加華<br/>xx_pipay:Pipay<br/>xx_truemoney:True Money<br/> |
| SeastarPay                                                   | (三) 交易結果電文<br/>(四) 交易回報確認電文                  | 儲值中心<br/>↓<br/>廠商 | AMOUNT=1000<br/>&CURRENCY_ID=TWD&CURRENCY_RATE=1<br/>&NT_AMOUNT=1000<br/><br/>AMOUNT：品項金額<br/>CURRENCY_ID：幣別ID<br/>CURRENCY_RATE：匯率<br/>NT_AMOUNT：換算台幣金額<br/> |
| 越南聯發 VGPAY                                               | (一)提出交易請求電文                                         | 廠商<br/>↓<br/>儲值中心 | CHANNEL_NO={支付通道}<br>BANK_NAME={銀行名稱，支付通道 2 和 3 必填}<br/><br/>[支付通道]<br/>0:momopay<br/>1:zalopay<br/>2:銀行掃碼<br/>3:銀行直連<br/>4:銀行網關<br/>5:VTPay<br/> |
| 越南聯發 VGPAY                                               | (三) 交易結果電文<br/>(四) 交易回報確認電文                  | 儲值中心<br/>↓<br/>廠商 | AMOUNT=1000<br/>&CURRENCY_ID=TWD&CURRENCY_RATE=1<br/>&NT_AMOUNT=1000<br/><br/>AMOUNT：品項金額<br/>CURRENCY_ID：幣別ID<br/>CURRENCY_RATE：匯率<br/>NT_AMOUNT：換算台幣金額<br/> |
| 印尼：<br>BankTransfers(CodaPay) Alfamart(CodaPay)<br>TrueMoney(CodaPay) Indomaret(CodaPay)<br>DokuWallet(CodaPay) Go-Pay(CodaPay)<br>OVO(CodaPay)<br>DANA(CodaPay)<br>XL(CodaPay)<br>Tri(CodaPay)<br>Smartfren(CodaPay)<br>菲律賓：<br>Globe (CodaPay)<br>Bank Transfer (CodaPay)<br>GCash (CodaPay)<br>7-Eleven PHCodaPay)<br>Convenience Store (CodaPay)<br>GrabPay (CodaPay)<br>新加坡：<br>GrabPay(CodaPay)<br>PayNow(CodaPay)<br />馬來：<br />Touch 'n Go(CodaPay) | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | MOBILE_MODE_FLAG=True& RESPONSE_MODE=0<br>&ORDER_DESC=XXXXX<br><br> MOBILE_MODE_FLAG：導向CodaPay付款頁面是否為手機版的模式，請傳入true OR false<br><br> ORDER_DESC：訂單描述(請翻譯成英文並無特殊符號，符號僅使用_ - +)<br><br>RESPONSE_MODE：回覆交易結果方式 <br> (0 = Client mode (Default) ; 1 = Server mode)<br>當為 Server mode，則不 Post 至指定網址，而是將結果以 JSON 結構印在畫面上<br><br>JSON輸出範例：<br>{<br>  "PLATFORM":"XXX",<br>  "AMOUNT":"XXX",<br>  "PLATFORM_TRANS_NO":"XXX",<br>  "PAY_TYPE":"XXX",<br>  "RETURN_URL":"XXX",<br>  "CENTER_TRANS_NO":"XXX",<br>  "RESULT_CODE":"XXX",<br>  "RESULT_MESSAGE":"XXX",<br>  "SETTLE_DATETIME":"XXX",<br>  "EXTEND":"AAA=BBB&CCC=DDD",<br>  "CHECK_CODE":"XXXXXXXXXXXXX"<br>} |
...
| 印尼：<br>CarrierBilling(CodaPay)<br>BankTransfers(CodaPay) Alfamart(CodaPay)<br>TrueMoney(CodaPay) Indomaret(CodaPay)<br>DokuWallet(CodaPay) Go-Pay(CodaPay)<br>菲律賓：<br>Globe (CodaPay)<br>Bank Transfer (CodaPay)<br>GCash (CodaPay)<br>7-Eleven PHCodaPay)<br>Convenience Store (CodaPay)<br>GrabPay (CodaPay)<br>新加坡：<br>GrabPay(CodaPay)<br>PayNow(CodaPay)<br />馬來：<br />Touch 'n Go(CodaPay) | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | AMOUNT=500000.00000<br>&CURRENCY_ID=IDR&CURRENCY_RATE= 0.00319&NT_AMOUNT=1595.00000&IS_CODASHOP=False<br><br>AMOUNT：品項金額<br>CURRENCY_ID：幣別ID<br>CURRENCY_RATE：匯率<br>NT_AMOUNT：換算台幣金額<br>IS_CODASHOP：是否為 CodaShop模式<br/><br>注意：<br>當RESULT_CODE=000000時，才會帶值<br>若訂單尚未確認已完成，會回傳RESULT_CODE=000005(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。) 此為『前端成功回覆代碼，但是不可作為請款依據，須依造(四) 交易回報確認電文回覆成功才給點(000000 or 000001)』 |
| 馬來：<br />Touch 'n Go(CodaShop)<br />GrabPay(CodaShop)<br />Boost(CodaShop)<br />Bank Transfers FPX(CodaShop)<br />Bank Transfers MAE(CodaShop)<br />Card Payment(CodaShop)<br />Shopee Pay(CodaShop)<br />泰國：<br />Rabbit LINE Pay(CodaShop)<br />True Money Wallet(CodaShop)<br />Bank Transfer(CodaShop)<br />7 Eleven(CodaShop)<br />Card Payment(CodaShop)<br />Coda Cash(CodaShop)<br />KPlus(CodaShop)<br />TrueMoney CashCard(CodaShop) | (二) 確認請求電文<br/>前端選擇品項的檢驗，CENTER_TRANS_NO<br/>不會帶值 | 儲值中心<br>↓<br>廠商 | PRODUCT_ID=1&USER_ID=xxxxxxxx<br><br />PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>USER_ID：欲儲值的帳號 |
| 馬來：<br />Touch 'n Go(CodaShop)<br />GrabPay(CodaShop)<br />Boost(CodaShop)<br />Bank Transfers FPX(CodaShop)<br />Bank Transfers MAE(CodaShop)<br />Card Payment(CodaShop)<br />Shopee Pay(CodaShop)<br />泰國：<br />Rabbit LINE Pay(CodaShop)<br />True Money Wallet(CodaShop)<br />Bank Transfer(CodaShop)<br />7 Eleven(CodaShop)<br />Card Payment(CodaShop)<br />Coda Cash(CodaShop)<br />KPlus(CodaShop)<br />TrueMoney CashCard(CodaShop) | (二) 確認請求電文 | 廠商<br/>↓<br/>儲值中心 | [用戶存在且品項有資格購買]<br />IDENTITY_1=yyy&IDENTITY_2=zzz&USER_NAME=xxx<br/><br />IDENTITY_1：廠商用戶識別值1，varchar(100)<br/>IDENTITY_2：廠商用戶識別值2，varchar(100)<br/>USER_NAME：玩家暱稱 (顯示在 CodaShop 介面上給用戶確認身分的，避免除錯帳號，看遊戲有什麼可以識別，例如暱稱)，varchar(100)<br /><br />[其他錯誤不給購買]<br />CODA_ERROR_CODE={錯誤代碼}&CODA_ERROR_MSG={錯誤訊息}<br />CODA_ERROR_CODE：CodaShop 會依據此代碼顯示錯誤訊息給用戶，varchar(20)<br/>CODA_ERROR_MSG：錯誤訊息，串接雙方內部使用，不會給用戶看到<br /><br />CODA_ERROR_CODE定義<br />-100 用戶不存在<br />-101 品項不存在<br />-102 品項不符合購買資格<br />-103 其他錯誤<br />-104 用戶未滿足條件<br />-105 須保持遊戲登入<br />-106 帳號未創建該伺服器角色<br />-107 已購買過此品項，不可重複買<br />-200 用戶不可在此[國家/地區]消費 |
| 馬來：<br />Touch 'n Go(CodaShop)<br />GrabPay(CodaShop)<br />Boost(CodaShop)<br />Bank Transfers FPX(CodaShop)<br />Bank Transfers MAE(CodaShop)<br />Card Payment(CodaShop)<br />Shopee Pay(CodaShop)<br />泰國：<br />Rabbit LINE Pay(CodaShop)<br />True Money Wallet(CodaShop)<br />Bank Transfer(CodaShop)<br />7 Eleven(CodaShop)<br />Card Payment(CodaShop)<br />Coda Cash(CodaShop)<br />KPlus(CodaShop)<br />TrueMoney CashCard(CodaShop) | (三) 交易結果電文<br/>(四) 交易回報確認電文 | 儲值中心<br/>↓<br/>廠商 | AMOUNT=500000.00000<br/>&CURRENCY_ID=IDR&CURRENCY_RATE= 0.00319&NT_AMOUNT=1595.00000&IS_CODASHOP=True<br/><br/>AMOUNT：品項金額<br/>CURRENCY_ID：幣別ID<br/>CURRENCY_RATE：匯率<br/>NT_AMOUNT：換算台幣金額<br/>IS_CODASHOP：是否為 CodaShop模式<br/><br/>注意：<br/>當RESULT_CODE=000000時，才會帶值<br/>若訂單尚未確認已完成，會回傳RESULT_CODE=000005(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。) 此為『前端成功回覆代碼，但是不可作為請款依據，須依造(四) 交易回報確認電文回覆成功才給點(000000 or 000001)』 |
...
| 閃快支付寶                                                   | (一)提出交易請求電文                              | 廠商<br>↓<br>儲值中心 | ORDER_DESC =xxxx<br>&RESPONSE_MODE=1<br><br>ORDER_DESC：品項描述<br>RESPONSE_MODE：回覆交易結果方式 <br> (0 = Client mode (Default) ; 1 = Server mode)<br>當為 Server mode，則不 Post 至指定網址，而是將結果以 JSON 結構印在畫面上<br><br>JSON輸出範例：<br>{<br>   "PLATFORM":"XXX",<br>   "AMOUNT":"XXX",<br>   "PLATFORM_TRANS_NO":"XXX",<br>   "PAY_TYPE":"XXX",<br>   "RETURN_URL":"XXX",<br>   "CENTER_TRANS_NO":"XXX",<br>   "RESULT_CODE":"XXX",<br>   "RESULT_MESSAGE":"XXX",<br>   "SETTLE_DATETIME":"XXX",<br>   "EXTEND":"AAA=BBB&CCC=DDD",<br>   "CHECK_CODE":"XXXXXXXXXXXXX"<br>} |
| 閃快支付寶                                                   | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | AMOUNT=160&CURRENCY_ID=CNY<br/>&CURRENCY_RATE=4.281&NT_AMOUNT=684.96<br/>&NT_PRICE=684.96<br/>AMOUNT：付款金額(人民幣)<br/>CURRENCY_ID：幣別ID，varchar(10)<br/>CURRENCY_RATE：該貨幣的買進匯率，decimal<br/>NT_AMOUNT：換算的台幣金額，decimal<br/>NT_PRICE：換算的台幣價值<br>注意：<br/>當RESULT_CODE=000000時，才會帶值<br/>若訂單尚未確認已完成，會回傳RESULT_CODE=000005(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。) 此為『前端成功回覆代碼，但是不可作為請款依據，須依造(四) 交易回報確認電文回覆成功才給點(000000 or 000001)』 |
...
| JSTPay | (一)提出交易請求電文 | 廠商<br>↓<br>儲值中心 | PAY_KIND={銀行}<br><br>THB銀行有兩家：<br>THBANK_PAY<br>PROMPT_PAY |
| JSTPay | (三) 交易結果電文<br>(四) 交易回報確認電文 | 儲值中心<br>↓<br>廠商 | AMOUNT=300.00000<br><br>AMOUNT：品項金額<br><br>注意：<br>當RESULT_CODE=000000時，才會帶值<br>若訂單尚未確認已完成，會回傳RESULT_CODE=000005(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。) 此為『前端成功回覆代碼，但是不可作為請款依據，須依造(四) 交易回報確認電文回覆成功才給點(000000 or 000001)』 |
...
| Upacp_PC(VNPay) Bank_Transfer(VNPay)<br>Bank_QR(VNPay) | (一)提出交易請求電文 | 廠商<br>↓<br>儲值中心 | BANK_CODE={銀行代碼}<br><br/>銀行代碼<br>VP<br/>ACB<br/>BIDV<br/>VTB<br/>MB<br/>EXB<br/>SAC<br/>TCB<br/>TPB<br/>VCB<br/>DAB<br/>SCB<br/>SAIGON |
| Momo_QR(VNPay) Zalo_QR(VNPay)<br/>Upacp_PC(VNPay)<br/>Bank_Transfer(VNPay)<br/>Bank_QR(VNPay)<br/>Viettel_QR(VNPay)<br/>Viettel_Fix_QR(VNPay)<br/>Rcgcard_PC(VNPay) | (三) 交易結果電文<br>(四) 交易回報確認電文 | 儲值中心<br>↓<br>廠商 | AMOUNT=500000.00000<br>&CURRENCY_ID=VND&CURRENCY_RATE= 0.00319&NT_AMOUNT=1595.00000<br><br>AMOUNT：品項金額<br>CURRENCY_ID：幣別ID<br>CURRENCY_RATE：匯率<br>NT_AMOUNT：換算台幣金額<br><br>注意：<br>當RESULT_CODE=000000時，才會帶值<br>若訂單尚未確認已完成，會回傳RESULT_CODE=000005(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。) 此為『前端成功回覆代碼，但是不可作為請款依據，須依造(四) 交易回報確認電文回覆成功才給點(000000 or 000001)』 |
| Bank_Transfer(TruePay)<br>Bank_QR(TruePay) | (一)提出交易請求電文 | 廠商<br>↓<br>儲值中心 | BANK_CODE={銀行代碼}<br><br/>銀行代碼<br>ACB<br/>SAC<br/>TCB<br/>VCB<br/>VTB<br/>DAB<br/>BIDV<br/>EXIM |
| Momo_QR(TruePay) Zalo_QR(TruePay)<br/>Bank_Transfer(TruePay)<br/>Bank_QR(TruePay) | (三) 交易結果電文<br>(四) 交易回報確認電文 | 儲值中心<br>↓<br>廠商 | AMOUNT=500000.00000<br>&CURRENCY_ID=VND&CURRENCY_RATE= 0.00319&NT_AMOUNT=1595.00000<br><br>AMOUNT：品項金額<br>CURRENCY_ID：幣別ID<br>CURRENCY_RATE：匯率<br>NT_AMOUNT：換算台幣金額<br><br>注意：<br>當RESULT_CODE=000000時，才會帶值<br>若訂單尚未確認已完成，會回傳RESULT_CODE=000005(交易尚未確認完成，請稍等片刻再確認您的帳戶和遊戲幣，如有問題請洽客服。) 此為『前端成功回覆代碼，但是不可作為請款依據，須依造(四) 交易回報確認電文回覆成功才給點(000000 or 000001)』 |
