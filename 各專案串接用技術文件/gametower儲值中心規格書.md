...
| 103 | Alipay 國際充值 | (一)廠商標準流程 |  | 國內IP需要，國外IP不需要 | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/Alipay/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/Alipay/Order.aspx<br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 118 | 支付寶行動版儲值 | (一)廠商標準流程 |  | 國內IP需要，國外IP不需要 | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/AlipayWap/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/AlipayWap/Order.aspx <br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 135 | ATM BCA(MimoPay) | (一)廠商標準流程 | | | 印尼ATM(BCA)儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/ATMBca/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/ATMBca/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000002到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 136 | ATM Bersama(MimoPay) | (一)廠商標準流程 | | | 印尼ATM(BERSAMA)儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/ATMBersam/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/ATMBersam/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000002到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 137 | Mimopay Telkomsel Airtime(MimoPay) | (一)廠商標準流程 | | | 印尼 Telkomsel 電信商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/UpointAirtime/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/UpointAirtime/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000002到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 138 | XL Airtime(MimoPay) | (一)廠商標準流程 | | | 印尼 XL 電信商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/XlAirtime/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/XlAirtime/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000002到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 139 | Mandiri E-Cash(MimoPay) | (一)廠商標準流程 | | | 印尼Mandiri銀行電子錢包儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/MandiriEcash/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/MandiriEcash/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 140 | Mandiri Clickpay(MimoPay) | (一)廠商標準流程 | | | 印尼Mandiri網路銀行儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/MandiriClickpay/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/MandiriClickpay/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 141 | Indosat Airtime(MimoPay) | (一)廠商標準流程 | | | 印尼 Indosat 電信商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/IndosatAirtime/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/IndosatAirtime/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 142 | Three Airtime(MimoPay) | (一)廠商標準流程 | | | 印尼 H3I 電信商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/ThreeAirtime/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/ThreeAirtime/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 143 | Convenience Store(MimoPay) | (一)廠商標準流程 | | | 印尼超商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/ConvenientStore/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/ConvenientStore/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 144 | Doku Wallet(MimoPay) | (一)廠商標準流程 | | | 印尼 Doku 電子錢包儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/Doku/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/Doku/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 145 | Digi Airtime(MimoPay) | (一)廠商標準流程 | | | 馬來西亞 Digi 電信商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/DpointAirtime/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/DpointAirtime/Order.aspx<br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +)<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 146 | Celcom Airtime(MimoPay) | (一)廠商標準流程 | | | 馬來西亞 Celcom 電信商儲值<br/><br/>提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/MimoPay/CelcomAirtime/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/MimoPay/CelcomAirtime/Order.aspx<br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/>PS1.一開始提出交易請求收到訂單後會回傳000003到RETURN_URL，代表請款 - 進行中；直到Mimopay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/>PS2.延伸欄位多帶USER_ID(玩家ID)、PRODUCT_ID(約定的品項ID)、ORDER_DESC(訂單描述；請翻譯成英文並無特殊符號，符號僅使用_ - +) |
| 148 | PePay 越南現金卡 | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/PePay/VnEntityCard/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/PePay/VnEntityCard/Order.aspx <br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
| 149 | PePay 越南銀行卡 | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/PePay/VnOnlineBank/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/PePay/VnOnlineBank/Order.aspx <br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間) |
...
| 184 | 閃快 – 微信支付儲值 | (一)廠商標準流程 | | | 提出交易請求電文連結位置：<br/>測試機：https://bank-twtest.towergame.com/Bank/TYPay/WeiXin/Order.aspx <br/>正式機：https://bank.gametower.com.tw/Bank/TYPay/WeiXin/Order.aspx <br/><br/>可直接串接的儲值中心：台版儲值中心(※若欲串接的儲值中心不在明細內，則專案串接時程需包含網頁組進行搬移作業的時間)<br/><br/>一開始提出交易請求收到訂單後會回傳000002到RETURN_URL(尚未明確知道交易是否成功)；直到TYPay透過Server Side 將實際購買電文使用CallBack方式傳給儲值中心後才會透過CHECK_URL通知請款完成。<br/><br/>會透過Extend方式回饋<br/>A.H5開APP用的連結『H5_URL』<br/>B.透過微信APP內的掃碼用的QRCode的圖檔連結『QRCODE_PIC_URL』<br/>給串接儲值中心的廠商，廠商們需自行刻畫面與寫JS語法去顯示跟開啟APP |
...
| 易利信簡訊<br>易利信語音                                     | (二) 確認請求電文                                            | 儲值中心<br>↓<br>廠商 | (1)資格確認：<br>PHONE=8869xxxxxxxx&SMS_MESSAGE=yyy<br>&CURRENCY_ID=HKD<br>&CURRENCY_RATE=30.1&NT_AMOUNT=35.2<br>&NT_PRICE=27&PRICE=0.9<br>PHONE：用戶門號，使用8869xxxxxxxx門號格式傳遞<br>SMS_MESSAGE：用戶發送的簡訊或語音內容<br>CURRENCY_ID：欲儲值的貨幣ID，varchar(10)<br>CURRENCY_RATE：該貨幣的買進匯率，decimal<br>NT_AMOUNT：換算的台幣金額，decimal<br>NT_PRICE：換算的台幣價值，decimal<br>PRICE：儲值的貨幣價值，decimal<br>(2) 簡訊發送結果通知：<br>SEND_RESULT=000000<br>SEND_RESULT：簡訊發送結果訊息，char(6)。<br>成功為 000000，否則為錯誤訊息、或是付費平台回應的資訊 |
| 易利信簡訊<br>易利信語音                                     | (二) 確認請求電文                                            | 廠商<br>↓<br>儲值中心 | (1)資格確認回覆：<br>SMS_MESSAGE= yyy<br>&IDENTITY_1=yyy&IDENTITY_2=zzz<br>SMS_MESSAGE：要回覆給用戶的簡訊內容， varchar(70)<br>IDENTITY_1：廠商用戶識別值1，varchar(100)<br>IDENTITY_2：廠商用戶識別值2，varchar(100)<br>(2) 簡訊發送結果通知回覆：<br>無需回覆 |
| 易利信簡訊<br>易利信語音                                     | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PRODUCT_ID=1&CURRENCY_ID=HKD<br>&CURRENCY_RATE=30.1&NT_AMOUNT=35.2<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>CURRENCY_ID：欲儲值的貨幣ID，varchar(10)<br>CURRENCY_RATE：該貨幣的買進匯率，decimal<br>NT_AMOUNT：換算的台幣金額，decimal |
...
| 全家超商輕鬆付<br>萊爾富超商輕鬆付                           | (二) 確認請求電文                                            | 儲值中心<br>↓<br>廠商 | USER_KEY=xxxxx<br>USER_KEY：便利超商通關碼，每個用戶專屬的一組KEY，提供使用者於便利超商機台輸入用，varchar(20)。 |
| 中華電信行動輕鬆付                                           | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | PRODUCT_ID=GT_100<br>PRODUCT_ID：雙方定義的品項ID，varchar(20) |
...
| Alipay國際充值                                               | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | ORDER_DESC=XXX<br>ORDER_DESC：要顯示於帳單上的商品說明，不帶的話預設為鈊象XXX元商品 |
...
| Hami 儲值                                                    | (二) 確認請求電文                                            | 儲值中心<br>↓<br>廠商 | PRODUCT_ID=1&USER_ID=xxxxxxxx &APP_ID=371.com.tw&QUANTITY=1<br>&HAMI_ORDER_NO=123456<br>&START_ID=13232&PRICE=0.9<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>USER_ID：欲儲值的帳號<br>CURRENCY_ID：欲儲值的貨幣ID，varchar(10)<br>APP_ID：識別是儲值到哪個App<br>QUANTITY：儲值品項數量 <br>Hami_ORDER_NO：Hami訂單編號<br>START_ID：給遊戲識別的StartID<br>PRICE：台幣價值，decimal |
| Hami 儲值                                                    | (二) 確認請求電文                                            | 廠商<br>↓<br>儲值中心 | IDENTITY_1=yyy&IDENTITY_2=zzz<br>&RETURN_URL=http://123.com.tw/Settle.aspx<br>IDENTITY_1：廠商用戶識別值1，varchar(100)<br>IDENTITY_2：廠商用戶識別值2，varchar(100)<br>RETURN_URL：最後回傳的網址 |
| Hami 儲值                                                    | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PRODUCT_ID=1&QUANTITY=1<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>QUANTITY：儲值品項數量 |
| Sonet信用卡儲值                                              | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | CREDITCARD_USER=abcd<br>&PRODUCT_ID=GT_100<br>CREDITCARD_USER：傳給Sonet，玩家儲值的識別值，varchar(50)。<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>注意： CREDITCARD_USER請勿用中文，如需Mask或用其他識別值請自行處理，儲值中心會將此值直接傳給Sonet。 |
| Sonet信用卡儲值                                              | (二) 確認請求電文<br>(三) 交易結果電文<br>(四) 交易回報確認電文 | 儲值中心<br>↓<br>廠商 | CARD_NO=123456******1234<br>CARD_NO：使用者輸入的卡號前六後四碼，中間使用*遮蔽，varchar(16) |
| 支付寶行動版儲值                                             | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | ORDER_DESC=XXX<br>ORDER_DESC：要顯示於帳單上的商品說明，不帶的話預設為鈊象XXX元商品 |
...
| PePay 越南現金卡                                             | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | 因為『越南現金卡』屬卡類交易<br>AMOUNT 請帶 0                |
| PePay 越南銀行卡                                             | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | PRODUCT_ID=IGS_XXXXX<br>PRODUCT_ID：雙方定義的品項ID，varchar(20) |
...
| PPS繳費靈(智冠)<br>港澳Visa信用卡(智冠)<br>八達通(智冠)<br>街口支付(智冠)<br>LINE Pay(智冠) | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | ORDER_DESC=XXXXXXXX<br>ORDER_DESC：商品說明，varchar(50)<br><br>若為街口支付且儲值方式是在安卓遊戲內的話<br>延伸欄位多帶APP_HOST_NAME、APP_SCHEME_NAME、APP_PACKAGE_NAME<br>詳細說明請看『四、付款方式代碼表』 |
| PPS繳費靈(智冠)<br>港澳Visa信用卡(智冠)<br>八達通(智冠)<br>街口支付(智冠)<br>LINE Pay(智冠) | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PROMO_CODE =XXXXXX<br>PROMO_CODE：活動代號，varchar(6)       |
...
| [ATM BCA]<br>[ATM Bersama]<br>[Mimopay Telkomsel Airtime]<br>[XL Airtime]<br>[Mandiri E-Cash]<br>[Mandiri Clickpay]<br>[Indosat Airtime]<br>[Three Airtime]<br>[Convenience Store]<br>[Doku Wallet]<br>[Celcom Airtime] | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | USER_ID=XXXX&PRODUCT_ID=XXXX<br>&ORDER_DESC=XXXXX<br> USER_ID：玩家ID<br> PRODUCT_ID：約定的品項ID<br> ORDER_DESC：訂單描述(請翻譯成英文並無特殊符號，符號僅使用_ - +)<br> |
| [Doku Wallet]                                                | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | USER_ID=XXXX&ORDER_DESC=XXXXX<br> USER_ID：玩家ID<br> ORDER_DESC：訂單描述(請翻譯成英文並無特殊符號，符號僅使用_ - +)<br> |
| [ATM BCA]<br>[ATM Bersama]<br>[Mimopay Telkomsel Airtime]<br>[XL Airtime]<br>[Mandiri E-Cash]<br>[Mandiri Clickpay]<br>[Indosat Airtime]<br>[Three Airtime]<br>[Convenience Store]<br>[Doku Wallet]<br>[Celcom Airtime] | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | AMOUNT=1000<br>&CURRENCY_ID=TWD&CURRENCY_RATE=1<br>&NT_AMOUNT=1000<br><br>AMOUNT：品項金額<br>CURRENCY_ID：幣別ID<br>CURRENCY_RATE：匯率<br>NT_AMOUNT：換算台幣金額<br><br>注意：<br>1. 當RESULT_CODE=000000時，才會帶值<br> |
| Vietnam Telco Vocuhers                                       | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | USER_ID=XXXX&TRADE_TYPE=2 <br>USER_ID：玩家ID<br>TRADE_TYPE：交易模式(1 or 2)，要與授權請求的交易模式一致。<br> |
| Vietnam Telco Vocuhers                                       | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | AMOUNT=1000<br>&CURRENCY_ID=TWD&CURRENCY_RATE=1<br>&NT_AMOUNT=1000<br>&SUGGESTED_POINT=1000<br><br>AMOUNT：品項金額<br>CURRENCY_ID：幣別ID<br>CURRENCY_RATE：匯率<br>NT_AMOUNT：換算台幣金額<br>SUGGESTED_POINT：建議點數(因交易金額換算點數有匯率的差異故提供建議點數方便廠商給點)<br><br>注意：<br>1. 當RESULT_CODE=000000時，才會帶值<br> |
| OPay(歐付寶) - 微信支付                                      | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | ORDER_DESC={商品名稱} x 數量<br>ORDER_DESC：商品說明(請按照下述規格帶入，不然會無法進行交易)，varchar(100)<br><br>規格：{商品名稱} x 數量<br>若為多個商品組合：{商品名稱} x 數量#{商品名稱} x 數量<br><br>e.g：1000金幣 x 1 或 金幣 x 1000 ...etc，提供參考....<br><br>x←大小寫沒差，前後是否有空格也沒差，但一定要帶 |
| OPay(歐付寶) - 微信支付                                      | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | AMOUNT=XXXXXX<br>AMOUNT：交易金額                            |
...
| 全家代碼儲值<br>萊爾富代碼儲值<br>OK代碼儲值                 | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | PRODUCT_ID=GT_100&ORDER_DESC=紅鑽&SHOP_PARA=123<br>PRODUCT_ID：雙方定義的品項ID，varchar(20)<br>ORDER_DESC：商品說明，varchar(128)<br>SHOP_PARA：廠商自訂參數(非必填)，Varchar（256），在(一)接收到什麼就會在(三)(四)回傳什麼 |
| 全家代碼儲值<br>萊爾富代碼儲值<br>OK代碼儲值                 | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | (三)當RESULT_CODE=000002時，將帶回繳費代碼相關資訊<br>PAY_ID=xxxxxxxx<br>PAY_ID：繳費代碼(varchar(32))<br>(四)當RESULT_CODE=000000時，表示玩家已繳費<br><br>SHOP_PARA=123<br><br>SHOP_PARA：廠商自訂參數(非必填)，Varchar（256），在(一)接收到什麼就會在(三)(四)回傳什麼 |
...
| 閃快微信支付                                                 | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | PRODUCT_DESC =xxxx<br>&RESPONSE_MODE=1<br><br>PRODUCT_DESC：品項描述<br>RESPONSE_MODE：回覆交易結果方式 <br> (0 = Client mode (Default) ; 1 = Server mode)<br>當為 Server mode，則不 Post 至指定網址，而是將結果以 JSON 結構印在畫面上<br><br>JSON輸出範例：<br>{<br>   "PLATFORM":"XXX",<br> "AMOUNT":"XXX",<br> "PLATFORM_TRANS_NO":"XXX",<br> "PAY_TYPE":"XXX",<br> "RETURN_URL":"XXX",<br>   "CENTER_TRANS_NO":"XXX",<br> "RESULT_CODE":"XXX",<br> "RESULT_MESSAGE":"XXX",<br>   "SETTLE_DATETIME":"XXX",<br>   "EXTEND":"AAA=BBB&CCC=DDD",<br>   "CHECK_CODE":"XXXXXXXXXXXXX"<br>} |
| 閃快微信支付                                                 | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | 當RESULT_CODE=000002時<br><br>將帶付款相關資訊與品項資訊<br>PAY_INFORMATION =XXXXX<br>&PRODUCT_DESC  =XXXXX<br>PAY_INFORMATION：付款資訊(行動裝置會回傳開APP用的 URL、WEB瀏覽器會回傳微信二維條碼)<br>PRODUCT_DESC：品項描述 |
