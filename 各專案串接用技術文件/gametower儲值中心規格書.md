...
| PPS繳費靈(智冠)<br>港澳Visa信用卡(智冠)<br>八達通(智冠)<br>MyCard轉點 | (一)提出交易請求電文                                         | 廠商<br>↓<br>儲值中心 | ORDER_DESC=XXXXXXXX<br>ORDER_DESC：商品說明，varchar(50)<br><br>若為街口支付或MyCard轉點且儲值方式是在安卓遊戲內的話<br>延伸欄位多帶APP_HOST_NAME、APP_SCHEME_NAME、APP_PACKAGE_NAME<br>詳細說明請看『四、付款方式代碼表』 |
| PPS繳費靈(智冠)<br>港澳Visa信用卡(智冠)<br>八達通(智冠)<br>MyCard轉點 | (三) 交易結果電文<br>(四) 交易回報確認電文                   | 儲值中心<br>↓<br>廠商 | PROMO_CODE =XXXXXX<br>PROMO_CODE：活動代號，varchar(6)       |
